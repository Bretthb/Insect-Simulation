 ...
 * to create drawings consisting of geometric shapes (e.g., points, lines,
 * circles, rectangles) in a window on your computer and to save the drawings to
 * a file.
 *
 * Todo ---- - Add support for gradient fill, etc. - Fix setCanvasSize() so that
 * it can be called only once. - Should setCanvasSize() reset xScale(),
 * yScale(), penRadius(), penColor(), and font() - On some systems, drawing a
 * line (or other shape) that extends way beyond canvas (e.g., to infinity)
 * dimensions does not get drawn.
 *
 ...
 * convenient way to find a desired color.
 * <p>
 * The second method allows you to specify colors using the {@link Color} data
 * type, which is defined in Java's {@link java.awt} pacakge. A number of colors
 * are predefined in standard drawing: {@link #BLACK}, {@link #BLUE},
 * {@link #CYAN}, {@link #DARK_GRAY}, {@link #GRAY}, {@link #GREEN},
 * {@link #LIGHT_GRAY}, {@link #MAGENTA}, {@link #ORANGE}, {@link #PINK},
 * {@link #RED}, {@link #WHITE}, {@link #YELLOW}, {@link #BOOK_BLUE},
 ...
 * called only once, at the very beginning of a program. For example,
 ...
 * </ul>
 * <p>
 * To specify the font, you use the {@link Font} data type, which is defined in
 * Java's {@link java.awt} package. This allows you to choose the face, size,
 * and style of the font. For example, the following code fragment sets the font
 * to Arial Bold, 60 point. The <code>import</code> statement allows you to
 * refer to <code>Font</code> directly, without needing the fully qualified name
 ...
 * call a drawing method—such as {@code point()} or {@code line()}—the
 ...
 * parameter and, later, reset it back to its original value.
 * <p>
...
public final class StdDraw implements ActionListener, MouseListener,
    ...
    /**
     * Shade of orange used in Princeton University's identity. It is PMS 158.
    ...
    private static void init() {
        ...
        frame = new JFrame();
        offscreenImage = new BufferedImage(2 * width, 2 * height,
                BufferedImage.TYPE_INT_ARGB);
        onscreenImage = new BufferedImage(2 * width, 2 * height,
                BufferedImage.TYPE_INT_ARGB);
        ...
        frame.setFocusTraversalKeysEnabled(false);  // allow VK_TAB with
                                                    // isKeyPressed()
     ...
     * <p>
     * The predefined pen colors are {@code StdDraw.BLACK},
     * {@code StdDraw.BLUE}, {@code StdDraw.CYAN}, {@code StdDraw.DARK_GRAY},
     * {@code StdDraw.GRAY}, {@code StdDraw.GREEN}, {@code StdDraw.LIGHT_GRAY},
     * {@code StdDraw.MAGENTA}, {@code StdDraw.ORANGE}, {@code StdDraw.PINK},
     * {@code StdDraw.RED}, {@code StdDraw.WHITE}, and {@code StdDraw.YELLOW}.
     *
     ...
     * @throws IllegalArgumentException if any coordinate is either NaN or
     *     infinite
     */
     ...
     * @throws IllegalArgumentException if {@code x} or {@code y} is either NaN
     *     or infinite
     */
    ...
    public static void point(double x, double y) {
        ...
        if (scaledPenRadius <= 1)
            ...
            offscreen.fill(new Ellipse2D.Double(xs - scaledPenRadius / 2,
                    ys - scaledPenRadius / 2, scaledPenRadius,
                    scaledPenRadius));
        draw();
    }
     ...
     * @throws IllegalArgumentException if any argument is either NaN or
     *     infinite
     */
     ...
     *     infinite
     */
    public static void arc(double x, double y, double radius, double angle1,
            double angle2) {
        validate(x, "x");
        validate(y, "y");
    ...
    /**
     * Draws a square of the specified size, centered at (<em>x</em>,
     * <em>y</em>).
     *
     ...
     * <em>y</em><sub>1</sub>), ..., (<em>x</em><sub><em>n</em>–1</sub>,
     ...
     * Seems to have some issues loading images on some systems and slows things
     * down on other systems. especially if you don't call
     * ImageIO.setUseCache(false) One advantage is that it returns a
     * BufferedImage.
     ***************************************************************************/
    /*
    ...
    */
     ...
     * @throws IllegalArgumentException if the image filename is invalid
     * @throws IllegalArgumentException if {@code x}, {@code y}, {@code degrees}
     *     is NaN or infinite
    ...
    /**
     * Writes the given text string in the current font, centered at
     * (<em>x</em>, <em>y</em>) and rotated by the specified number of degrees.
     * 
     * @param x the center <em>x</em>-coordinate of the text
     * @param y the center <em>y</em>-coordinate of the text
     * @param text the text to write
     ...
     *     {@code degrees} is either NaN or infinite
     */
     ...
     *     {@link #show()}, and {@link #pause(int t)}
     */
    @Deprecated
     ...
     * {@code line()}, {@code circle()}, and {@code square()} will be deferred
     * until the next call to show(). Useful for animations.
     */
    ...
    /**
     * Disables double buffering. All subsequent calls to drawing methods such
     * as {@code line()}, {@code circle()}, and {@code square()} will be
     * displayed on screen when called. This is the default.
     */
    ...
    public static void save(String filename) {
        ...
        // need to change from ARGB to RGB for JPEG
            ...
            BufferedImage rgbBuffer = new BufferedImage(2 * width, 2 * height,
     ...
     *
     * @return {@code true} if the mouse is being pressed; {@code false}
     *     otherwise
     */
